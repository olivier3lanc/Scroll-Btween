...
* `V` is the start value of the CSS property when [intersection](how-it-works.html) is equal (in percent) to `0`.
* `W` is the start value of the CSS property when [intersection](how-it-works.html) is equal (in percent) to `a`.
* `X` is the start value of the CSS property when [intersection](how-it-works.html) is equal (in percent) to `b`.
* `Y` is the intermediate value of the CSS property when [intersection](how-it-works.html) is equal (in percent) to `c`.
* `Z` is the intermediate value of the CSS property when [intersection](how-it-works.html) is equal (in percent) to `100`.
* etc
